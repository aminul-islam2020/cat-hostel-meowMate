    ...
    async function loadProducts() {
        try {
            ...
            result.products.forEach(product => {
                ...
                card.innerHTML = `
                    <div class="relative">
                        <img src="${product.image || '/placeholder.svg?height=200&width=300&text=No+Image'}" 
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-600 text-sm mb-3">${product.short_desc || ''}</p>
                        ...
                        <div class="flex gap-2">
                            ...
                            <button onclick="addToCart(${product.id})" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-2 rounded-md transition-colors">
